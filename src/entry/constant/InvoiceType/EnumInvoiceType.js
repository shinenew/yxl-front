...
export function transformType(str) {
    if (str) {
        str = str.toUpperCase();
        switch (str) {
...
//获取发票城市
export function getCityName(invoice) {
...
// 验真状态
export function transformReal(record) {
    if (record) {
 ...
 * @param {*合规状态} str 
 */
export function transformStandard(str) {
    if (str) {
        str = str.toUpperCase();
        switch (str) {
            case "UNCHECK":
...
// 重复录票状态
export function transformDuplicate(str) {
    if (str) {
        str = str.toUpperCase();
        switch (str) {
            case "UNCHECK":
...
// 财务状态
export function transformFinance(str) {
    if (str) {
        str = str.toUpperCase();
        switch (str) {
            case "UNCHECK":
...
//状态对应的样式颜色
export function transformColor(str) {
    if (str) {
        str = str.toUpperCase();
        switch (str) {
            case "UNCHECK":
...
// 是否识别状态
export function transformdecodeQRState(str) {
    if (str) {
        str = str.toUpperCase();
        switch (str) {
            case "FAILED":
...
//发票状态
export function transformInvoiceStatus(str) {
    if (str) {
        str = str.toUpperCase();
        switch (str) {
            case 'NORMAL':
...
export function transformLoggedStateEnum(str) {
    if (str) {
        str = str.toUpperCase();
        switch (str) {
            case 'LOGGED':
...
//MatchStateEnum 匹配枚举
export function transformMatchStateEnum(str) {
    str = str.toUpperCase();
    switch (str) {
        case 'UNMATCH':
...
export function transformInvoiceAuthStateEnum(str) {
    str = str.toUpperCase();
    switch (str) {
        case 'UNCHECK':
            return '';
...
export function transformInvoiceDraftStateEnum(str) {
    str = str.toUpperCase();
    switch (str) {
        case 'DRAFT_UNCOMMIT':
